    ...
    <div class="max-w-md w-full">
      <div class="text-center mb-8">
        ...
        <p class="mt-2 text-gray-600 dark:text-gray-400">
          Truy cập danh sách nhãn hiệu đã lưu và nhiều hơn nữa
        </p>
      </div>
          ...
          <div>
            ...
            <div class="relative">
              <input id="password" v-model="form.password" :type="showPassword ? 'text' : 'password'" required
                autocomplete="current-password" class="input-field pr-12" placeholder="••••••••" />
      ...
      <div class="mt-6 card p-4 bg-blue-50 dark:bg-blue-900/20 border-blue-200 dark:border-blue-800">
        <p class="text-sm text-blue-800 dark:text-blue-300 font-medium mb-2">Tài khoản Demo:</p>
