...
<template>
  <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 animate-fade-in">
    ...
    <!-- Empty state -->
    <UiEmptyState
      v-else-if="notificationStore.allNotifications.length === 0"
    ...
    <div v-else class="space-y-3">
      <div
        ...
        :class="[
          ...
          !notification.read ? 'border-l-4 border-primary-500 bg-primary-50/50 dark:bg-primary-900/10' : ''
        ]"
      >
            ...
            <div class="flex items-start justify-between">
              <div class="flex-1">
                <h3 class="font-semibold text-gray-900 dark:text-gray-100 mb-1">
                  {{ notification.title }}
                  <span v-if="!notification.read" class="ml-2 inline-block w-2 h-2 bg-primary-500 rounded-full"></span>
                </h3>
